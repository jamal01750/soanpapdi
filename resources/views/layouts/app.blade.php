...
<head>
    ...
    <title>@yield('title', 'Aronno Bazar')</title>
    ...
    <div class="flex min-h-screen bg-slate-100/50">
        ...
        <div class="flex flex-col flex-1 w-full lg:pl-64">
            ...
            <header class="sticky top-0 z-30 flex items-center justify-between px-4 py-3 bg-white/80 backdrop-blur-sm border-b border-slate-200 sm:px-6 lg:px-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Welcome to Aronno Bazar Management</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-3 sm:space-x-5">
                    ...
                    <!-- <div class="relative">
                        <a href="#" class="relative block p-2 text-slate-500 rounded-full hover:bg-slate-100 hover:text-sky-600" aria-label="View notifications">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-cloak @click.away="open = false"
                            ...
                            <div class="py-1">
                                ...
                                <a href="{{ route('profile.edit') }}" class="flex items-center w-full px-4 py-2 text-sm text-left text-slate-700 hover:bg-slate-100">
            ...
            <footer class="px-4 sm:px-6 lg:px-8 py-4 text-center text-sm text-slate-500 border-t border-slate-200 bg-white">
                &copy; {{ date('Y') }} Aronno Bazar Management. All rights reserved.
            </footer>
        </div>
    </div>
</body>
